...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'middle_name' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'password' => ['type' => 'string', 'length' => 200, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'role_id' => 1,
                'created_at' => '2019-03-23 12:17:28',
                'modified_at' => '2019-03-23 12:17:28'
            ],
        ];
        parent::init();
    }
